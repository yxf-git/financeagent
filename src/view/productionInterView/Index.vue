<template>
  <div class="production_interview_analysis">
    ...
    <div class="right_content">
      <div
        class="no_data"
        v-if="messageStore.rightContentType === CONTENTTYPE.NODATA"
      >
        <img src="../../assets/img/data_empty.png" />
      </div>
      <InformationDisplay
        class="comp_content"
        v-else-if="messageStore.rightContentType === CONTENTTYPE.TEXT"
      ></InformationDisplay>

      <BatchAnalysis
        class="comp_content"
        v-else-if="messageStore.rightContentType === CONTENTTYPE.CHART"
      ></BatchAnalysis>
    </div>
    <!-- 弹出层 -->
    <el-dialog
