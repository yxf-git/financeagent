...
import {getLLMChat, getLLMChatAw, requestFileList, requestFileListAw, requestFileListAw1} from "../../http/api";
...
export const useCommentAwStore1 = defineStore('commend1', {
    state:() =>({
    ...
    actions:{
        ...
        async getFileList() {
            ...
            let fileList = await requestFileListAw1();
